...
dep_ras <- terra::rast(filenames$depth)
terra::set.names(dep_ras, filenames$flow_cfs)
dep <- dep_ras |> 
  st_as_stars() |> 
  st_set_dimensions(3, names="flow") |>
  setNames("depth")

vel_ras <- terra::rast(filenames$velocity)
terra::set.names(vel_ras, filenames$flow_cfs)
vel <- vel_ras |> 
  st_as_stars() |> 
  st_set_dimensions(3, names="flow") |>
  setNames("velocity")

deer_dep_vel <- c(dep, vel)
