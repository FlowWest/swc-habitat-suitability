...
# method=4 uses simple 1/0 thresholds from HQT
...
get_reach_result <- function(r) {
  ...
  flows |> 
    lapply(function(q) get_reach_flow_result(r, q)) |> 
    bind_rows() |>
...
yuba_calc_reach_hsis <- function(r) {
  ...
  yuba_comid |>
    ...
    mutate(result = map2(geometry, flow_cfs, function(g, q) yuba_calc_comid_hsi(st_sfc(g, crs=st_crs(yuba_comid)), q, t))) |>
    unnest_wider(result) |>
    st_as_sf() |>
    glimpse()
