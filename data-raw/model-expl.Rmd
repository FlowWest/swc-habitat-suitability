...
si_rec <- recipe(data=training(td_split), 
  ...
  # add quadratic??
  # step_poly(flow_norm_cfs, keep_original_cols=T) |>
  # step_interact(terms = ~ flow_norm_cfs_poly_2:all_predictors()) |>
...
sd_rec <- recipe(data=training(td_split), 
  ...
  #step_interact(terms = ~hqt_gradient_class:all_numeric_predictors())
  # add quadratic??
  # step_poly(flow_cfs, keep_original_cols=T) |>
  # step_interact(terms = ~ flow_cfs_poly_2:all_predictors()) |>
  step_dummy(hqt_gradient_class) |>
  step_dummy(hyd_cls) |>
