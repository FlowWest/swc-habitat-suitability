...
stan_domain <- st_read(file.path("/vsizip", here::here("data-raw", "source", "hydraulic_model_data/stanislaus_srh2d_2013/StanMesh072313_Domain.shp.zip")), as_tibble=T)

# SRH2D model domain, manually split into polygons aligning with COMID segments
stan_comid <- st_read(file.path("/vsizip", here::here("data-raw", "source", "hydraulic_model_data/stanislaus_srh2d_2013/StanMesh072313_Domain_COMID.shp.zip")), as_tibble=T) |>
  st_zm() |> janitor::clean_names()

# SRH2D mesh vertices, converted from 2DM using QGIS 
stan_vertices <- st_read(file.path("/vsizip", here::here("data-raw", "source", "hydraulic_model_data/stanislaus_srh2d_2013/StanMesh072313_Vertices.shp.zip")), as_tibble=T) |>
  mutate(vid = row_number()) |>
  select(vid)

# Thiessen (aka Voronoi) polygons for mesh vertices, generated using QGIS
stan_thiessen <- st_read(file.path("/vsizip", here::here("data-raw", "source", "hydraulic_model_data/stanislaus_srh2d_2013/StanMesh072313_Thiessen.shp.zip")), as_tibble=T) |>
...
stan_elev <- read_csv(here::here("data-raw", "source", "hydraulic_model_data/stanislaus_srh2d_2013/StanMesh072313_BedElevation.csv.gz")) |>
  janitor::clean_names() |>
  mutate(vid = row_number()) |>
...
stan_material_n <-
  read_delim(here::here("data-raw", "source", "hydraulic_model_data/stanislaus_srh2d_2013/manning_coef.txt"), delim="\t", col_names=c("manning_coef")) |>
...
stan_material <- 
  read_csv(here::here("data-raw", "source", "hydraulic_model_data/stanislaus_srh2d_2013/StanMesh072313_MaterialID.csv.gz")) |>
  janitor::clean_names() |>
  mutate(vid = row_number()) |>
...
stan_result_filenames <- c(
   "500" = here::here("data-raw", "source", "hydraulic_model_data/stanislaus_srh2d_2013/500cfs_072313.csv.gz"),
   "750" = here::here("data-raw", "source", "hydraulic_model_data/stanislaus_srh2d_2013/750cfs_072413.csv.gz"),
  "1000" = here::here("data-raw", "source", "hydraulic_model_data/stanislaus_srh2d_2013/1000cfs_072413.csv.gz"),
  "1250" = here::here("data-raw", "source", "hydraulic_model_data/stanislaus_srh2d_2013/1250cfs_090313.csv.gz"),
  "1500" = here::here("data-raw", "source", "hydraulic_model_data/stanislaus_srh2d_2013/1500cfs_071013.csv.gz"),
  "1750" = here::here("data-raw", "source", "hydraulic_model_data/stanislaus_srh2d_2013/1750cfs_090313.csv.gz"),
  "2250" = here::here("data-raw", "source", "hydraulic_model_data/stanislaus_srh2d_2013/2250cfs_121713.csv.gz"),
  "3000" = here::here("data-raw", "source", "hydraulic_model_data/stanislaus_srh2d_2013/3000cfs_061913.csv.gz"),
  "5000" = here::here("data-raw", "source", "hydraulic_model_data/stanislaus_srh2d_2013/5000cfs_071113.csv.gz")
)
